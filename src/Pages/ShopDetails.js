    ...
    apiClient.get("/sanctum/csrf-cookie").then(() => {
      ...
      apiClient
        ...
        .then((response) => {
          ...
          setProductSummary(cleanedSummary);

          setProductPrice(product.price);
          setProductCostPrice(product.cost_price);

          const cleanedDetailInfo = DOMPurify.sanitize(product.detail_info);
          setProductDetailInfo(cleanedDetailInfo);

          const cleanedProductDescription = DOMPurify.sanitize(product.desc);
          setProductDescription(cleanedProductDescription);
