...
export const subcategories = [
  ...
  new Subcategory(11, "Bia, Đồ uống", "/category/11"),
  new Subcategory(12, "Thực phẩm chay", "/category/12"),
  new Subcategory(13, "Dành cho trẻ em", "/category/13"),
  new Subcategory(14, "Bánh kẹo, Giỏ quà", "/category/14"),
  new Subcategory(15, "Thức ăn, Đồ thú cưng", "/category/15"),
  new Subcategory(16, "Chăm sóc cá nhân", "/category/16"),

  new Subcategory(17, "Chăm sóc nhà cửa", "/category/17"),
];
